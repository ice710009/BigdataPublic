	...
	<div class="col-md-10">		  			
		<div class="row">		
			<div class="content-box-header" style="background-color:#D1E9E9;">
				<div class="panel-title">NCTU碩博士生生源分析<a href="{{ url('/analysis/analysis_menu') }}">(回選單)</a></div>
			</div>			
			<p>
			@if(Session::get('permission') == config('GV.dean'))
				<div class="btn-group">
...
<script>
	...
	function selectAcademeHandler(){
		...
		if ($( "#academe" ).val() == '1'){
			...
			$("#department option").remove();
			var request = $.ajax({
				url: "/analysis/source/get_departments",
				type: "GET",
