	...
	<div class="col-md-10">		  	
  			...
  			<div class="col-md-12 panel-warning">
  				...
  				<div class="panel-body">
					...
					<font face="DFKai-sb" color="#262626" size="4">（業務單位：人事室；最近更新日期:106/4/18）</font><br>
  					<font face="DFKai-sb" color="#262626" size="4"><a href="{{ url('/info_public/oth_info/4-4-106.xlsx') }}">
